...
<body style="background: red">
    <div id="app" >
        <nav class="navbar navbar-expand-md navbar-dark bg-dark shadow-sm" style="background: darkred">
            <div class="container">
                <a href="{{ url('/') }}">
                    <img src={{ asset('publicidad/image00124.png') }} width="50px" height="50px">
                </a>
